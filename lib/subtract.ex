defmodule Momento.Subtract do
  ...
  def subtract(%DateTime{month: month, day: day} = datetime, num, :days)
      ...
      do:
        subtract(%DateTime{datetime | day: days_in_month(month - 1)}, 1, :months)
        |> subtract(num - day, :days)
  ...
  def subtract(%DateTime{minute: minute} = datetime, num, :minutes)
      ...
      do:
        subtract(%DateTime{datetime | minute: 59}, 1, :hours)
        |> subtract(num - minute - 1, :minutes)
  ...
  def subtract(%DateTime{second: second} = datetime, num, :seconds)
      ...
      do:
        subtract(%DateTime{datetime | second: 59}, 1, :minutes)
        |> subtract(num - second - 1, :seconds)
  ...
  def subtract(%DateTime{microsecond: {_, precision}} = datetime, num, :microseconds)
    ...
    subtract(datetime, seconds, :seconds)
    |> subtract(num - seconds * microsecond_factor(precision), :microseconds)
  end
  ...
  def subtract(%DateTime{microsecond: {microsecond, precision}} = datetime, num, :microseconds)
      ...
      do:
        subtract(%DateTime{datetime | microsecond: {999_999, precision}}, 1, :seconds)
