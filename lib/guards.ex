defmodule Momento.Guards do
  ...
  ## Examples
      ...
      false
  """
  defguard natural?(num) when is_integer(num) and num >= 0
  ...
  ## Examples
      ...
      false
  """
  defguard positive?(num) when is_integer(num) and num > 0
  ...
  ## Examples
      ...
      false
  """
  defguard negative?(num) when is_integer(num) and num < 0
